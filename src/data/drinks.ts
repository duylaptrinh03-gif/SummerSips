...
export const drinks: Drink[] = [
  // ── CÀ PHÊ ────────────────────────────────────────────────────────────
  {
    ...
    description: "Cà phê phin truyền thống đậm đà, pha cùng sữa đặc thơm ngon. Uống với đá mát lạnh — đúng vị Việt Nam.",
    category: "Cà Phê",
    tag: "Yêu Thích",
    isAvailable: true,
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Ly cà phê sữa tỷ lệ ngược — nhiều sữa, ít cà phê. Ngọt ngào, béo ngậy, phù hợp cho người mới uống.",
    category: "Cà Phê",
    isAvailable: true,
    rating: 4.5,
    soldCount: 1890,
  ...
  // ── TRÀ SỮA ───────────────────────────────────────────────────────────
  {
    ...
    description: "Trà Assam đậm đà pha cùng sữa tươi, ngọt nhẹ. Topping trân châu đen dai giòn cực nghiện.",
    category: "Trà Sữa",
    tag: "Bán Chạy",
    isAvailable: true,
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Bột matcha Nhật Bản chất lượng cao hòa quyện với sữa tươi. Màu xanh đẹp mắt, vị thanh dịu.",
    category: "Trà Sữa",
    tag: "Mới",
    isAvailable: true,
    rating: 4.7,
  ...
  },
  {
    ...
    description: "Khoai môn tím nghiền mịn pha cùng sữa tươi. Màu tím độc đáo, vị béo bùi khó cưỡng.",
    category: "Trà Sữa",
    isAvailable: true,
    rating: 4.6,
    soldCount: 1750,
  ...
  // ── TRÀ TRÁI CÂY ──────────────────────────────────────────────────────
  {
    ...
    description: "Trà xanh ướp cùng đào tươi, cam vắt và lá sả thơm. Thanh mát, chua nhẹ, giải nhiệt mùa hè.",
  ...
  },
  {
    ...
    description: "Trà chanh vắt tươi, pha chút muối biển. Vị chua mặn ngọt hài hòa, cực giải khát.",
    category: "Trà Trái Cây",
    tag: "Bán Chạy",
    isAvailable: true,
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Dâu tây tươi xay nhuyễn hòa cùng trà xanh và nước đường. Màu hồng quyến rũ, vị ngọt chua tự nhiên.",
    category: "Trà Trái Cây",
    tag: "Mới",
    isAvailable: true,
    rating: 4.5,
  ...
  // ── SINH TỐ ───────────────────────────────────────────────────────────
  {
    ...
    description: "Xoài Cát Hòa Lộc chín mọng xay cùng sữa tươi và đá. Béo ngậy, thơm ngon, đúng vị mùa hè.",
    category: "Sinh Tố",
    tag: "Yêu Thích",
    isAvailable: true,
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Bơ sáp xay cùng sữa đặc và sữa tươi. Béo mịn, bổ dưỡng, thỏa mãn cơn thèm.",
    category: "Sinh Tố",
    isAvailable: true,
    rating: 4.6,
    soldCount: 1340,
  ...
  // ── NƯỚC ÉP ───────────────────────────────────────────────────────────
  {
    ...
    description: "Cam vắt tươi nguyên chất 100%, không đường, không phụ gia. Giàu vitamin C, tốt cho sức khỏe.",
    category: "Nước Ép",
    tag: "Lành Mạnh",
    isAvailable: true,
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Dưa hấu đỏ mọng xay nguyên chất. Ngọt tự nhiên, mát lạnh, giải khát cực đỉnh ngày nóng.",
    category: "Nước Ép",
    tag: "Lành Mạnh",
    isAvailable: true,
    rating: 4.7,
